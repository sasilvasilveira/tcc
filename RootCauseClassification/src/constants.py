...
COLUMNS_WITH_SAME_WORDS_AS_REMAINING_COLUMNS = ["Descrição"]
...
ROOT_CAUSE_CLASSIFICATION = {
    ...
    "Concepção": [
        ...
        "C21: Regra de negócio mal definida",
        "C22: Experiência do usuário",
    ],
    "Implantação": [
        "C6: Alteração externa não prevista (api ou lib externa modificada)",
        "C18: Efeito colateral",
        "C19: Erro na inicialização de parâmetros",
    ],
}
